...
% test.m
%
% Model exported on Jul 29 2017, 09:49 by COMSOL 5.2.1.229.
...
model.physics('br').feature('out1').selection.set([35 36 41 42 122 123 166 171]);
model.physics('br').feature('out1').set('BoundaryCondition', 'Pressure');
model.physics('br').create('inl3', 'InletBoundary', 2);
model.physics('br').feature('inl3').selection.set([57 58 128 131 157 162]);
...
model.param.set('lambda_critical', 0.9993027133314093, 'lambda_engeinvalue to get to criticality');
...
model.physics('br').feature('inl3').selection.set([51 52 57 58 128 131 157 162]);

model.geom('geom1').feature('wp1').geom.feature('pol1').setIndex('table', '0.35', 8, 0);
model.geom('geom1').feature('wp1').geom.feature('pol1').setIndex('table', '1.5', 8, 1);
model.geom('geom1').feature('wp1').geom.feature('pol1').setIndex('table', '0.35', 9, 0);
model.geom('geom1').feature('wp1').geom.feature('pol1').setIndex('table', '2.5', 9, 1);
model.geom('geom1').feature('wp1').geom.feature('pol1').move('table', 8, 9, 7);
model.geom('geom1').feature('wp1').geom.feature('pol1').move('tableconstr', 8, 9, 7);
model.geom('geom1').feature('wp1').geom.feature('pol1').move('table', 7, 8, 6);
model.geom('geom1').feature('wp1').geom.feature('pol1').move('tableconstr', 7, 8, 6);
model.geom('geom1').feature('wp1').geom.feature('pol1').move('table', 6, 7, 5);
model.geom('geom1').feature('wp1').geom.feature('pol1').move('tableconstr', 6, 7, 5);
model.geom('geom1').feature('wp1').geom.feature('pol1').move('table', 5, 6, 4);
model.geom('geom1').feature('wp1').geom.feature('pol1').move('tableconstr', 5, 6, 4);
model.geom('geom1').feature('wp1').geom.feature('pol1').move('table', 4, 5, 3);
model.geom('geom1').feature('wp1').geom.feature('pol1').move('tableconstr', 4, 5, 3);
model.geom('geom1').feature('wp1').geom.feature('pol1').move('table', 3, 4, 4);
model.geom('geom1').feature('wp1').geom.feature('pol1').move('tableconstr', 3, 4, 4);
model.geom('geom1').feature('wp1').geom.feature('pol1').move('table', 9, 10, 8);
model.geom('geom1').feature('wp1').geom.feature('pol1').move('tableconstr', 9, 10, 8);
model.geom('geom1').feature('wp1').geom.feature('pol1').move('table', 8, 9, 7);
model.geom('geom1').feature('wp1').geom.feature('pol1').move('tableconstr', 8, 9, 7);
model.geom('geom1').feature('wp1').geom.feature('pol1').move('table', 7, 8, 6);
model.geom('geom1').feature('wp1').geom.feature('pol1').move('tableconstr', 7, 8, 6);
...
model.geom('geom1').feature('wp1').geom.feature('pol6').setIndex('table', '3.805', 6, 1);
model.geom('geom1').feature('wp1').geom.run('pol6');
model.geom('geom1').run;

model.view('view1').set('renderwireframe', true);

model.physics('br').feature('out1').selection.set([39 40 41 42 126 127 174 179]);
model.physics('br').create('inl4', 'InletBoundary', 2);
...
model.physics('br').feature('inl4').selection.set([77 78 145 160]);
...
model.result('pg1').feature('slc1').set('differential', true);
model.result('pg1').feature('slc1').set('data', 'parent');
model.result.dataset.create('surf1', 'Surface');
model.result.dataset('surf1').label('Exterior Walls');
model.result.dataset('surf1').set('data', 'dset2');
model.result.dataset('surf1').selection.geom('geom1', 2);
model.result.dataset('surf1').selection.set([35 36 37 38 49 50 53 54 59 60 61 62 63 64 67 68 71 72 73 74 75 76 124 125 131 133 136 137 138 140 142 143 144 157 158 159 161 162 163 164 166 171 173 177]);
...
model.result('pg2').feature('surf1').set('differential', true);
...
model.result('pg3').feature('surf1').set('expr', 'T_flibe');
...
model.result('pg4').feature('iso1').label('Isosurface');
model.result('pg4').feature('iso1').set('expr', 'T_flibe');
...
model.result('pg5').feature('surf1').set('expr', 'T_fuel');
model.result('pg5').feature('surf1').set('colortable', 'ThermalLight');
model.result('pg5').feature('surf1').set('data', 'parent');
model.result.create('pg6', 'PlotGroup3D');
model.result('pg6').label('Isothermal Contours (ht3)');
model.result('pg6').set('data', 'dset2');
model.result('pg6').feature.create('iso1', 'Isosurface');
model.result('pg6').feature('iso1').label('Isosurface');
model.result('pg6').feature('iso1').set('expr', 'T_fuel');
model.result('pg6').feature('iso1').set('number', 10);
model.result('pg6').feature('iso1').set('colortable', 'ThermalLight');
model.result('pg6').feature('iso1').set('data', 'parent');
model.result.create('pg7', 3);
model.result('pg7').set('data', 'dset2');
model.result('pg7').create('slc1', 'Slice');
model.result('pg7').feature('slc1').set('expr', 'Flux1');
...
model.param.set('T_inlet', 'T0_flibe');
...
model.result('pg1').feature('slc1').label('Slice');
model.result('pg1').feature('slc1').set('oldanalysistype', 'noneavailable');
model.result('pg1').feature('slc1').set('solvertype', 'none');
model.result('pg1').feature('slc1').set('differential', true);
model.result('pg1').feature('slc1').set('data', 'parent');
model.result.dataset('surf1').set('data', 'dset2');
model.result.dataset('surf1').selection.geom('geom1', 2);
...
model.physics('ht').feature('temp1').selection.set([9 10 17 18 19 20 27 28 29 32 34]);

model.view('view1').hideObjects.clear;
model.view('view1').hideEntities.clear;
model.view('view1').hideMesh.clear;

model.physics('ht').feature('temp1').selection.set([9 10 17 18 19 20 27 28 29 32 34 53 54 59 60 133 136 163 166]);
model.physics('ht').feature('ofl1').selection.set([15 16 23 24 39 41 42 43 44 48 126 127 174]);
...
model.physics('ht').feature('temp1').selection.set([9 10 17 18 19 20 27 28 29 32 34 53 54 59 60 75 76 133 136 144 159 163 166]);
...
model.physics('br').feature('inl4').set('BoundaryCondition', 'MassFlow');
model.physics('br').feature('inl4').set('mfr', 'mL*(1-bottomInletFraction)');

model.result.create('pg11', 'PlotGroup3D');
model.result('pg11').label('Velocity (br)');
...
model.result('pg11').feature('slc1').label('Slice');
model.result('pg11').feature('slc1').set('oldanalysistype', 'noneavailable');
model.result('pg11').feature('slc1').set('differential', true);
model.result('pg11').feature('slc1').set('data', 'parent');
model.result.dataset('surf1').set('data', 'dset2');
model.result.dataset('surf1').selection.geom('geom1', 2);
model.result.dataset('surf1').selection.set([35 36 37 38 49 50 53 54 59 60 61 62 63 64 67 68 71 72 73 74 75 76 124 125 131 133 136 137 138 140 142 143 144 157 158 159 161 162 163 164 166 171 173 177]);
model.result.dataset('surf1').selection.inherit(false);
model.result.create('pg12', 'PlotGroup3D');
model.result('pg12').label('Pressure (br)');
model.result('pg12').set('data', 'surf1');
model.result('pg12').set('oldanalysistype', 'noneavailable');
model.result('pg12').set('title', 'Surface contour: Pressure (Pa)');
model.result('pg12').set('frametype', 'spatial');
model.result('pg12').set('titletype', 'auto');
model.result('pg12').set('data', 'surf1');
model.result('pg12').feature.create('surf1', 'Surface');
model.result('pg12').feature('surf1').label('Surface');
model.result('pg12').feature('surf1').set('oldanalysistype', 'noneavailable');
model.result('pg12').feature('surf1').set('expr', '1');
model.result('pg12').feature('surf1').set('differential', true);
model.result('pg12').feature('surf1').set('titletype', 'none');
model.result('pg12').feature('surf1').set('isuniformshown', true);
model.result('pg12').feature('surf1').set('isuniform', true);
...
model.result('pg12').feature('con1').label('Pressure');
model.result('pg12').feature('con1').set('oldanalysistype', 'noneavailable');
model.result('pg12').feature('con1').set('expr', 'p');
model.result('pg12').feature('con1').set('differential', true);
...
model.result('pg13').label('Temperature (ht)');
...
model.result('pg13').feature('surf1').set('expr', 'T_flibe');
model.result('pg13').feature('surf1').set('colortable', 'ThermalLight');
model.result('pg13').feature('surf1').set('data', 'parent');
model.result.create('pg14', 'PlotGroup3D');
model.result('pg14').label('Isothermal Contours (ht)');
model.result('pg14').set('data', 'dset2');
model.result('pg14').feature.create('iso1', 'Isosurface');
model.result('pg14').feature('iso1').label('Isosurface');
model.result('pg14').feature('iso1').set('expr', 'T_flibe');
model.result('pg14').feature('iso1').set('number', 10);
model.result('pg14').feature('iso1').set('colortable', 'ThermalLight');
model.result('pg14').feature('iso1').set('data', 'parent');
model.result.create('pg15', 'PlotGroup3D');
model.result('pg15').label('Temperature (ht3)');
...
model.result('pg15').feature('surf1').set('expr', 'T_fuel');
...
model.result('pg16').label('Isothermal Contours (ht3)');
model.result('pg16').set('data', 'dset2');
model.result('pg16').feature.create('iso1', 'Isosurface');
model.result('pg16').feature('iso1').label('Isosurface');
model.result('pg16').feature('iso1').set('expr', 'T_fuel');
model.result('pg16').feature('iso1').set('number', 10);
model.result('pg16').feature('iso1').set('colortable', 'ThermalLight');
model.result('pg16').feature('iso1').set('data', 'parent');
model.result.create('pg17', 3);
model.result('pg17').set('data', 'dset2');
model.result('pg17').create('slc1', 'Slice');
model.result('pg17').feature('slc1').set('expr', 'Flux1');
...
model.study('std5').feature('stat').set('physselection', 'br');
...
model.study('std5').feature('stat').set('useinitsol', 'on');
model.study('std5').feature('stat').set('physselection', 'br');
model.study('std5').feature('stat').set('activate', {'br' 'on' 'ht' 'off' 'ht3' 'on' 'neutrondiffusion' 'off'});
model.study('std5').feature('stat').set('physselection', 'br');
model.study('std5').feature('stat').set('activate', {'br' 'on' 'ht' 'off' 'ht3' 'off' 'neutrondiffusion' 'off'});
...
model.result('pg11').set('showlooplevel', {'off' 'off' 'off'});
model.result('pg11').set('frametype', 'spatial');
model.result('pg11').set('data', 'dset2');
model.result('pg11').feature.create('slc1', 'Slice');
model.result('pg11').feature('slc1').label('Slice');
model.result('pg11').feature('slc1').set('oldanalysistype', 'noneavailable');
model.result('pg11').feature('slc1').set('solvertype', 'none');
model.result('pg11').feature('slc1').set('differential', true);
model.result('pg11').feature('slc1').set('data', 'parent');
model.result.dataset('surf1').set('data', 'dset2');
model.result.dataset('surf1').selection.geom('geom1', 2);
...
model.result('pg12').feature('con1').label('Pressure');
model.result('pg12').feature('con1').set('oldanalysistype', 'noneavailable');
model.result('pg12').feature('con1').set('solvertype', 'none');
model.result('pg12').feature('con1').set('expr', 'p');
model.result('pg12').feature('con1').set('differential', true);
model.result('pg12').feature('con1').set('number', 40);
model.result('pg12').feature('con1').set('data', 'parent');
...
model.physics('neutrondiffusion').feature.duplicate('init2', 'init1');
model.physics('neutrondiffusion').feature.move('init2', 3);
model.physics('br').feature('out1').set('BoundaryCondition', 'Pressure');
model.physics('br').feature('out1').selection.set([]);

model.view('view1').set('renderwireframe', false);

model.physics('br').feature('out1').selection.set([53 54 59 60 133 136 163 166]);
...
model.result.dataset('surf1').set('data', 'dset2');
model.result.dataset('surf1').selection.geom('geom1', 2);
model.result.dataset('surf1').selection.set([35 36 37 38 39 40 41 42 49 50 61 62 63 64 67 68 71 72 73 74 75 76 77 78 124 125 126 127 131 137 138 140 142 143 144 145 157 158 159 160 161 162 164 171 173 174 177 179]);
model.result.dataset('surf1').selection.inherit(false);
model.result.create('pg12', 'PlotGroup3D');
model.result('pg12').label('Pressure (br)');
model.result('pg12').set('data', 'surf1');
...
model.physics('neutrondiffusion').feature.remove('init2');
model.physics('neutrondiffusion').feature('dir1').selection.set([1 2 3 4 5 6 9 10 11 12 15 16 17 18 21 22 23 24 33 34 51 52 53 54 57 58 59 60 65 66 69 70 81 82 83 84 89 90 93 94 101 102 105 106 107 108 109 111 112 114 115 117 118 123 132 133 135 136 139 141 147 148 151 152 154 155 163 165 166 170 172 175 183 185 186 188 189 191 192 193 196 197 200 201 209 210 211 212]);
...
model.physics('br').feature('inl4').active(true);
model.physics('br').feature('out1').selection.set([39 40 41 42 126 127 174 179]);
...
model.study('std5').feature('stat').set('physselection', 'br');
model.study('std5').feature('stat').set('activate', {'br' 'on' 'ht' 'on' 'ht3' 'off' 'neutrondiffusion' 'off'});
model.study('std5').feature('stat').set('physselection', 'br');
model.study('std5').feature('stat').set('activate', {'br' 'on' 'ht' 'on' 'ht3' 'on' 'neutrondiffusion' 'off'});
model.study('std5').feature('stat').set('physselection', 'br');
model.study('std5').feature('stat').set('activate', {'br' 'on' 'ht' 'on' 'ht3' 'on' 'neutrondiffusion' 'on'});
model.study('std5').feature('stat').set('physselection', 'br');
model.study('std5').feature('stat').set('activate', {'br' 'on' 'ht' 'on' 'ht3' 'on' 'neutrondiffusion' 'off'});
model.study('std5').feature('stat').set('usesol', 'on');
...
model.study('std5').feature('stat').set('notsolmethod', 'init');
model.study('std5').feature('stat').set('notstudy', 'zero');
model.study('std5').feature('stat').set('physselection', 'br');
model.study('std5').feature('stat').set('activate', {'br' 'on' 'ht' 'on' 'ht3' 'on' 'neutrondiffusion' 'on'});
model.study('std5').feature('stat').set('useinitsol', 'off');
model.study('std5').feature('stat').set('usesol', 'off');
model.study('std5').feature('stat').set('useinitsol', 'on');
model.study('std5').feature('stat').set('initmethod', 'sol');
model.study('std5').feature('stat').set('initstudy', 'std2');
...
model.study('std5').feature('stat').set('physselection', 'br');
model.study('std5').feature('stat').set('activate', {'br' 'on' 'ht' 'off' 'ht3' 'on' 'neutrondiffusion' 'on'});
model.study('std5').feature('stat').set('physselection', 'br');
model.study('std5').feature('stat').set('activate', {'br' 'on' 'ht' 'off' 'ht3' 'off' 'neutrondiffusion' 'on'});
model.study('std5').feature('stat').set('physselection', 'br');
model.study('std5').feature('stat').set('activate', {'br' 'on' 'ht' 'off' 'ht3' 'off' 'neutrondiffusion' 'off'});
model.study('std5').feature('stat').set('initmethod', 'init');
model.study('std5').feature('stat').set('initstudy', 'zero');
model.study('std5').feature('stat').set('usesol', 'on');
...
model.result('pg13').feature('surf1').set('expr', 'br.P');
model.result('pg13').feature('surf1').set('data', 'cpl1');
model.result('pg13').run;
model.result.dataset('cpl1').set('data', 'dset2');
model.result.dataset('cpl1').run;
model.result('pg13').run;
model.result('pg13').feature('surf1').set('expr', 'p');
model.result('pg13').feature('surf1').set('descr', 'Pressure');
model.result('pg13').run;
model.result('pg13').run;
...
model.result('pg13').run;
model.result('pg13').feature('str1').set('posmethod', 'magnitude');
model.result('pg13').feature('str1').set('mdensity', '200');
model.result('pg13').run;
model.result('pg13').feature('str1').set('mdensity', '50');
model.result('pg13').run;
model.result('pg11').run;
model.result('pg11').run;

model.physics('br').feature('inl4').set('mfr', 'vel_in(z, 1.29)');
model.physics('br').feature('inl4').set('BoundaryCondition', 'Velocity');
...
model.physics('br').feature('inl4').selection.set([75 76 144 159]);
...
model.result('pg11').run;
model.result('pg11').feature('slc1').set('expr', 'br.vort_magn');
model.result('pg11').feature('slc1').set('descr', 'Vorticity magnitude');
model.result('pg11').feature('slc1').set('expr', 'br.U');
...
model.result('pg13').run;
model.result('pg13').run;
model.result('pg13').feature('surf1').active(false);
model.result('pg13').run;
model.result('pg13').run;
model.result('pg13').feature('str1').set('inheritplot', 'none');
model.result('pg11').run;
model.result('pg11').run;
model.result('pg13').run;
model.result('pg13').feature('str1').set('posmethod', 'uniform');
model.result('pg13').run;
model.result('pg13').feature('str1').set('linetype', 'line');
model.result('pg13').run;
model.result('pg13').run;
...
model.result('pg13').run;
model.result('pg13').feature('str1').set('posmethod', 'uniform');
model.result('pg13').feature('str1').set('udist', '0.01');
model.result('pg13').run;
model.result('pg13').feature('str1').set('color', 'cyan');
model.result('pg10').set('window', 'window3');
model.result('pg10').set('windowtitle', '');
model.result('pg10').run;
model.result('pg9').set('window', 'window2');
model.result('pg9').set('windowtitle', '');
...
model.result('pg13').run;
model.result('pg13').feature('arwl1').set('arrowcount', '2000');
model.result('pg13').run;
model.result('pg13').feature('arwl1').set('placement', 'uniformani');
model.result('pg13').feature.remove('arwl1');
model.result('pg13').run;
model.result('pg13').create('surf1', 'Surface');
model.result('pg13').feature('surf1').set('expr', 'v');
model.result('pg13').feature('surf1').set('descr', 'Velocity field, y component');
model.result('pg13').run;
model.result('pg13').run;
model.result('pg13').feature('str1').active(false);
model.result('pg13').run;

model.physics('br').feature('inl3').set('BoundaryCondition', 'Velocity');
model.physics('br').feature('inl4').set('BoundaryCondition', 'Velocity');
model.physics('br').feature('inl4').set('U0in', '0.5');
model.physics('br').feature('inl4').set('ComponentWise', 'NormalInflowVelocity');
...
model.result('pg11').run;
model.result('pg13').run;
model.result('pg13').feature('str1').active(true);
model.result('pg13').run;
model.result('pg13').run;
...
model.result('pg13').run;
model.result('pg13').run;
model.result('pg13').feature('surf1').set('expr', 'U');
model.result('pg13').run;
model.result('pg13').feature('surf1').set('expr', 'v');
model.result('pg13').run;
model.result('pg13').run;
...
model.result('pg15').feature('str1').selection.set([53 59 60 132 155 158]);
model.result('pg15').run;
model.result('pg15').feature('str1').set('selnumber', '200');
model.result('pg15').run;
...
model.result('pg15').run;
model.result('pg15').run;
model.result('pg15').feature('str1').set('expr', {'u' 'v' 'w'});
model.result('pg15').feature('str1').set('descr', 'Velocity field');
model.result('pg15').run;
model.result('pg15').run;
model.result('pg15').set('allowtableupdate', false);
model.result('pg15').set('allowevalintitle', false);
model.result('pg15').set('title', 'Streamline: Velocity field');
model.result('pg15').set('hasbeenplotted', true);
model.result('pg15').feature('str1').set('hasbeenplotted', true);
model.result('pg15').set('renderdatacached', false);
model.result('pg15').set('allowtableupdate', true);
model.result('pg15').set('renderdatacached', true);
model.result('pg15').run;
model.result('pg15').feature('str1').selection.set([53 54 59 60 133 136 163 166]);
model.result('pg15').run;
model.result('pg15').feature('str1').selection.set([133 136]);
model.result('pg15').run;
...
model.result('pg15').feature('str1').selection.set([76 133 136]);
...
model.study('std6').feature('stat').activate('br', true);
model.study('std6').feature('stat').activate('ht', true);
model.study('std6').feature('stat').activate('ht3', true);
model.study('std6').feature('stat').activate('neutrondiffusion', true);
model.study('std6').feature('stat').set('physselection', 'br');
model.study('std6').feature('stat').set('activate', {'br' 'off' 'ht' 'on' 'ht3' 'on' 'neutrondiffusion' 'on'});
model.study('std6').feature('stat').set('useinitsol', 'on');
model.study('std6').feature('stat').set('initmethod', 'sol');
model.study('std6').feature('stat').set('initstudy', 'std2');
...
model.sol('sol17').feature('st1').set('study', 'std6');
...
model.sol('sol17').feature('s1').create('se1', 'Segregated');
model.sol('sol17').feature('s1').feature('se1').feature.remove('ssDef');
model.sol('sol17').feature('s1').feature('se1').create('ss1', 'SegregatedStep');
model.sol('sol17').feature('s1').feature('se1').feature('ss1').set('segvar', {'mod1_T_flibe'});
model.sol('sol17').feature('s1').feature('se1').feature('ss1').set('subdamp', 0.7);
model.sol('sol17').feature('s1').create('d1', 'Direct');
model.sol('sol17').feature('s1').feature('d1').set('linsolver', 'pardiso');
model.sol('sol17').feature('s1').feature('se1').feature('ss1').set('linsolver', 'd1');
model.sol('sol17').feature('s1').feature('se1').feature('ss1').label('Temperature T_flibe');
model.sol('sol17').feature('s1').feature('se1').create('ss2', 'SegregatedStep');
model.sol('sol17').feature('s1').feature('se1').feature('ss2').set('segvar', {'mod1_T_fuel'});
model.sol('sol17').feature('s1').feature('se1').feature('ss2').set('subdamp', 0.8);
model.sol('sol17').feature('s1').feature('se1').feature('ss2').set('subjtech', 'onevery');
model.sol('sol17').feature('s1').create('d2', 'Direct');
model.sol('sol17').feature('s1').feature('d2').set('linsolver', 'pardiso');
model.sol('sol17').feature('s1').feature('se1').feature('ss2').set('linsolver', 'd2');
model.sol('sol17').feature('s1').feature('se1').feature('ss2').label('Temperature T_fuel');
model.sol('sol17').feature('s1').feature('se1').create('ss3', 'SegregatedStep');
model.sol('sol17').feature('s1').feature('se1').feature('ss3').set('segvar', {'mod1_Flux1' 'mod1_Flux2' 'mod1_Flux3' 'mod1_Flux4' 'mod1_Flux5' 'mod1_Flux6' 'mod1_Flux7' 'mod1_Flux8' 'mod1_Conc1' 'mod1_Conc2'  ...
'mod1_Conc3' 'mod1_Conc4' 'mod1_Conc5' 'mod1_Conc6'});
model.sol('sol17').feature('s1').feature('se1').feature('ss3').set('linsolver', 'dDef');
model.sol('sol17').feature('s1').feature('se1').create('ll1', 'LowerLimit');
model.sol('sol17').feature('s1').feature('se1').feature('ll1').set('lowerlimit', 'mod1.T_flibe 0 mod1.T_fuel 0 ');
model.sol('sol17').feature('s1').create('i1', 'Iterative');
model.sol('sol17').feature('s1').feature('i1').create('mg1', 'Multigrid');
model.sol('sol17').feature('s1').create('i2', 'Iterative');
model.sol('sol17').feature('s1').feature('i2').create('mg1', 'Multigrid');
model.sol('sol17').feature('s1').feature.remove('fcDef');
model.sol('sol17').attach('std6');
...
model.result('pg16').feature('surf1').set('expr', 'T_flibe');
model.result('pg16').feature('surf1').set('colortable', 'ThermalLight');
model.result('pg16').feature('surf1').set('data', 'parent');
model.result.create('pg17', 'PlotGroup3D');
model.result('pg17').label('Isothermal Contours (ht)');
model.result('pg17').set('data', 'dset4');
model.result('pg17').feature.create('iso1', 'Isosurface');
model.result('pg17').feature('iso1').label('Isosurface');
model.result('pg17').feature('iso1').set('expr', 'T_flibe');
model.result('pg17').feature('iso1').set('number', 10);
model.result('pg17').feature('iso1').set('colortable', 'ThermalLight');
model.result('pg17').feature('iso1').set('data', 'parent');
model.result.create('pg18', 'PlotGroup3D');
model.result('pg18').label('Temperature (ht3)');
...
model.result('pg18').feature('surf1').set('expr', 'T_fuel');
model.result('pg18').feature('surf1').set('colortable', 'ThermalLight');
model.result('pg18').feature('surf1').set('data', 'parent');
model.result.create('pg19', 'PlotGroup3D');
model.result('pg19').label('Isothermal Contours (ht3)');
model.result('pg19').set('data', 'dset4');
model.result('pg19').feature.create('iso1', 'Isosurface');
model.result('pg19').feature('iso1').label('Isosurface');
model.result('pg19').feature('iso1').set('expr', 'T_fuel');
model.result('pg19').feature('iso1').set('number', 10);
model.result('pg19').feature('iso1').set('colortable', 'ThermalLight');
model.result('pg19').feature('iso1').set('data', 'parent');
model.result.create('pg20', 3);
model.result('pg20').set('data', 'dset4');
model.result('pg20').create('slc1', 'Slice');
model.result('pg20').feature('slc1').set('expr', 'Flux1');
...
model.study('std6').feature('stat').set('physselection', 'br');
model.study('std6').feature('stat').set('activate', {'br' 'on' 'ht' 'on' 'ht3' 'on' 'neutrondiffusion' 'on'});
...
model.sol('sol17').feature.remove('s1');
model.sol('sol17').feature.remove('v1');
model.sol('sol17').feature.remove('st1');
model.sol('sol17').create('st1', 'StudyStep');
model.sol('sol17').feature('st1').set('study', 'std6');
model.sol('sol17').feature('st1').set('studystep', 'stat');
model.sol('sol17').create('v1', 'Variables');
...
model.sol('sol17').feature('s1').feature('se1').feature.remove('ssDef');
model.sol('sol17').feature('s1').feature('se1').create('ss1', 'SegregatedStep');
model.sol('sol17').feature('s1').feature('se1').feature('ss1').set('segvar', {'mod1_u' 'mod1_p'});
model.sol('sol17').feature('s1').create('i1', 'Iterative');
model.sol('sol17').feature('s1').feature('i1').set('linsolver', 'gmres');
model.sol('sol17').feature('s1').feature('i1').set('prefuntype', 'left');
model.sol('sol17').feature('s1').feature('i1').set('itrestart', 50);
model.sol('sol17').feature('s1').feature('i1').set('rhob', 20);
model.sol('sol17').feature('s1').feature('i1').set('maxlinit', 200);
model.sol('sol17').feature('s1').feature('i1').set('nlinnormuse', 'on');
model.sol('sol17').feature('s1').feature('i1').create('mg1', 'Multigrid');
model.sol('sol17').feature('s1').feature('i1').feature('mg1').set('prefun', 'gmg');
model.sol('sol17').feature('s1').feature('i1').feature('mg1').set('mcasegen', 'any');
model.sol('sol17').feature('s1').feature('i1').feature('mg1').set('gmglevels', 1);
model.sol('sol17').feature('s1').feature('i1').feature('mg1').feature('pr').create('sl1', 'SORLine');
model.sol('sol17').feature('s1').feature('i1').feature('mg1').feature('pr').feature('sl1').set('iter', 1);
model.sol('sol17').feature('s1').feature('i1').feature('mg1').feature('pr').feature('sl1').set('linerelax', 0.3);
model.sol('sol17').feature('s1').feature('i1').feature('mg1').feature('pr').feature('sl1').set('linealgorithm', 'matrix');
model.sol('sol17').feature('s1').feature('i1').feature('mg1').feature('pr').feature('sl1').set('linemethodmatrix', 'coupled');
model.sol('sol17').feature('s1').feature('i1').feature('mg1').feature('pr').feature('sl1').set('linevar', 'mod1_u');
model.sol('sol17').feature('s1').feature('i1').feature('mg1').feature('pr').feature('sl1').set('maxline', 15);
model.sol('sol17').feature('s1').feature('i1').feature('mg1').feature('pr').feature('sl1').set('seconditer', 1);
model.sol('sol17').feature('s1').feature('i1').feature('mg1').feature('pr').feature('sl1').set('relax', 0.3);
model.sol('sol17').feature('s1').feature('i1').feature('mg1').feature('po').create('sl1', 'SORLine');
model.sol('sol17').feature('s1').feature('i1').feature('mg1').feature('po').feature('sl1').set('iter', 3);
model.sol('sol17').feature('s1').feature('i1').feature('mg1').feature('po').feature('sl1').set('linerelax', 0.4);
model.sol('sol17').feature('s1').feature('i1').feature('mg1').feature('po').feature('sl1').set('linealgorithm', 'matrix');
model.sol('sol17').feature('s1').feature('i1').feature('mg1').feature('po').feature('sl1').set('linemethodmatrix', 'coupled');
model.sol('sol17').feature('s1').feature('i1').feature('mg1').feature('po').feature('sl1').set('linevar', 'mod1_u');
model.sol('sol17').feature('s1').feature('i1').feature('mg1').feature('po').feature('sl1').set('maxline', 20);
model.sol('sol17').feature('s1').feature('i1').feature('mg1').feature('po').feature('sl1').set('seconditer', 2);
model.sol('sol17').feature('s1').feature('i1').feature('mg1').feature('po').feature('sl1').set('relax', 0.4);
model.sol('sol17').feature('s1').feature('i1').feature('mg1').feature('cs').create('d1', 'Direct');
model.sol('sol17').feature('s1').feature('i1').feature('mg1').feature('cs').feature('d1').set('linsolver', 'pardiso');
model.sol('sol17').feature('s1').feature('se1').feature('ss1').set('linsolver', 'i1');
model.sol('sol17').feature('s1').feature('se1').feature('ss1').label('Velocity u, Pressure p');
model.sol('sol17').feature('s1').feature('se1').create('ss2', 'SegregatedStep');
model.sol('sol17').feature('s1').feature('se1').feature('ss2').set('segvar', {'mod1_T_flibe'});
model.sol('sol17').feature('s1').feature('se1').feature('ss2').set('subdamp', 0.7);
model.sol('sol17').feature('s1').create('d1', 'Direct');
model.sol('sol17').feature('s1').feature('d1').set('linsolver', 'pardiso');
model.sol('sol17').feature('s1').feature('se1').feature('ss2').set('linsolver', 'd1');
model.sol('sol17').feature('s1').feature('se1').feature('ss2').label('Temperature T_flibe');
model.sol('sol17').feature('s1').feature('se1').create('ss3', 'SegregatedStep');
model.sol('sol17').feature('s1').feature('se1').feature('ss3').set('segvar', {'mod1_T_fuel'});
model.sol('sol17').feature('s1').feature('se1').feature('ss3').set('subdamp', 0.8);
model.sol('sol17').feature('s1').feature('se1').feature('ss3').set('subjtech', 'onevery');
model.sol('sol17').feature('s1').create('d2', 'Direct');
model.sol('sol17').feature('s1').feature('d2').set('linsolver', 'pardiso');
model.sol('sol17').feature('s1').feature('se1').feature('ss3').set('linsolver', 'd2');
model.sol('sol17').feature('s1').feature('se1').feature('ss3').label('Temperature T_fuel');
model.sol('sol17').feature('s1').feature('se1').create('ss4', 'SegregatedStep');
model.sol('sol17').feature('s1').feature('se1').feature('ss4').set('segvar', {'mod1_Flux1' 'mod1_Flux2' 'mod1_Flux3' 'mod1_Flux4' 'mod1_Flux5' 'mod1_Flux6' 'mod1_Flux7' 'mod1_Flux8' 'mod1_Conc1' 'mod1_Conc2'  ...
'mod1_Conc3' 'mod1_Conc4' 'mod1_Conc5' 'mod1_Conc6'});
model.sol('sol17').feature('s1').feature('se1').feature('ss4').set('linsolver', 'dDef');
model.sol('sol17').feature('s1').feature('se1').set('maxsegiter', 150);
model.sol('sol17').feature('s1').feature('se1').create('ll1', 'LowerLimit');
model.sol('sol17').feature('s1').feature('se1').feature('ll1').set('lowerlimit', 'mod1.T_flibe 0 mod1.T_fuel 0 ');
model.sol('sol17').feature('s1').create('i2', 'Iterative');
model.sol('sol17').feature('s1').feature('i2').create('mg1', 'Multigrid');
model.sol('sol17').feature('s1').create('i3', 'Iterative');
model.sol('sol17').feature('s1').feature('i3').create('mg1', 'Multigrid');
model.sol('sol17').feature('s1').feature.remove('fcDef');
model.sol('sol17').attach('std6');
...
model.physics('ht').prop('PhysicalModelProperty').set('HeatTransferInPorousMedia', false);
...
model.result('pg16').feature('vol1').set('expr', 'T_fuel');
model.result('pg16').feature('vol1').set('descr', 'Temperature');
model.result('pg16').run;
model.result('pg16').run;
model.result('pg16').set('data', 'dset2');
model.result('pg16').run;
...
model.result('pg16').run;
model.result('pg16').run;
model.result('pg16').feature('vol1').set('expr', 'Flux1');
model.result('pg16').run;
model.result('pg16').feature('vol1').set('expr', 'Flux2');
model.result('pg16').run;
model.result('pg16').feature('vol1').set('data', 'dset1');
model.result('pg16').run;
