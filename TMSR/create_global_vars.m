...
%volume for each part
model.param.set('V_fuel', '4/3*pi*R3^3/3[m^3]', 'volume of fuel kernel in a triso, divided into three equivolume layers');
...
model.param.set('triso_nb', '11558/3', 'number of triso in each fuel layer');
