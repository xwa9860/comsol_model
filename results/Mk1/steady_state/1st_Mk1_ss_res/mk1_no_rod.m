...
% mk1_no_rod.m
%
% Model exported on Aug 31 2017, 13:13 by COMSOL 5.3.0.260.
...
model.component('mod1').geom('geom1').feature('wp1').geom.feature('fil1').active(false);
model.component('mod1').geom('geom1').feature('wp1').geom.feature('fil1').set('radius', 0.5);
model.component('mod1').geom('geom1').feature('wp1').geom.feature('fil1').selection('point').set('pol2(1)', [1 4]);
model.component('mod1').geom('geom1').feature('wp1').geom.create('fil2', 'Fillet');
model.component('mod1').geom('geom1').feature('wp1').geom.feature('fil2').active(false);
model.component('mod1').geom('geom1').feature('wp1').geom.feature('fil2').set('selresult', true);
model.component('mod1').geom('geom1').feature('wp1').geom.feature('fil2').set('radius', 1);
model.component('mod1').geom('geom1').feature('wp1').geom.feature('fil2').selection('point').set('fil1(1)', [2]);
...
model.component('mod1').geom('geom1').feature('wp1').geom.create('int1', 'Intersection');
model.component('mod1').geom('geom1').feature('wp1').geom.feature('int1').active(false);
model.component('mod1').geom('geom1').feature('wp1').geom.feature('int1').set('keep', true);
model.component('mod1').geom('geom1').feature('wp1').geom.feature('int1').selection('input').set({'fil2'});
...
model.component('mod1').view('view2').axis.set('xmin', -2.9335336685180664);
model.component('mod1').view('view2').axis.set('xmax', 1.724355936050415);
model.component('mod1').view('view2').axis.set('ymin', 2.926530122756958);
model.component('mod1').view('view2').axis.set('ymax', 6.2762274742126465);
model.component('mod1').view('view2').axis.set('abstractviewlratio', -0.3296191990375519);
model.component('mod1').view('view2').axis.set('abstractviewrratio', -0.012342745438218117);
model.component('mod1').view('view2').axis.set('abstractviewbratio', 0.5108720064163208);
model.component('mod1').view('view2').axis.set('abstractviewtratio', 0.09561457484960556);
model.component('mod1').view('view2').axis.set('abstractviewxscale', 0.0045266179367899895);
model.component('mod1').view('view2').axis.set('abstractviewyscale', 0.004526618402451277);
model.component('mod1').view('view3').axis.set('xmin', -1.119140625);
model.component('mod1').view('view3').axis.set('xmax', 1.119140625);
model.view('view4').axis.set('xmin', -5.51845121383667);
model.view('view4').axis.set('xmax', 5.51845121383667);
model.view('view4').axis.set('ymin', 0.016770362854003906);
model.view('view4').axis.set('ymax', 6.127729415893555);
...
model.view('view5').axis.set('xmin', -5.333669185638428);
model.view('view5').axis.set('xmax', 5.333669185638428);
model.view('view5').axis.set('ymin', 0.1503748893737793);
model.view('view5').axis.set('ymax', 5.994124889373779);
