...
model.component('mod1').mesh('mesh1').feature('ftet2').feature('size1').set('hauto', 7); %coarser
...
model.component('mod1').mesh('mesh1').feature('size').set('hauto', 7); %coarser
model.component('mod1').mesh('mesh1').feature('ftet3').feature('size1').set('hauto', 5); %normal

model.component('mod1').mesh('mesh1').feature('ftet6').feature('size1').set('hauto', 5); %normal
model.component('mod1').mesh('mesh1').feature('ftet5').feature('size1').set('hauto', 7); %coarser
