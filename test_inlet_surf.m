...
% test_inlet_surf.m
%
% Model exported on Aug 1 2017, 09:58 by COMSOL 5.2.1.229.
...
model.param.set('Pop', '0');

model.physics('br').feature('inl2').selection.set([]);
model.physics('br').feature('inl2').active(false);
...
model.result.dataset('surf1').selection.set([35 36 37 38 49 50 61 62 63 64 67 68 71 72 73 74 75 76 77 78 124 125 131 137 138 140 142 143 144 145 157 158 159 160 161 162 164 171 173 177]);
...
model.param.rename('Pb_diam', 'pb_diam');
