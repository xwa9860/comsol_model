...
if MultiScale
<<<<<<< HEAD
    temp_var_pb = '(Tp2+Tp3+Tp4+Tp5)/4.0'; % name of the comsol variable for fuel temperature
=======
    temp_var_pb = '(Tp1+Tp2+Tp3)/3.0'; % name of the comsol variable for fuel temperature
>>>>>>> 10f63122cddf148eaa50de412c84a65474c1139e
