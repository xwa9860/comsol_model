...
model.physics('ht').selection.set(flibe_domains);

model.physics('ht').create('temp1', 'TemperatureBoundary', dimNb-1);
model.physics('ht').feature('temp1').selection.set(inlet_temp_bound);
...
model.physics('ht').feature('hs2').selection.set(fuel_domNb);
