...
model.physics('ht3').selection.set(fuel_domNb);
model.physics('ht3').create('solid1', 'SolidHeatTransferModel', dimNb);
model.physics('ht3').feature('solid1').selection.set(fuel_domNb);
model.physics('ht3').create('hs1', 'HeatSource', dimNb);
model.physics('ht3').feature('hs1').selection.set(fuel_domNb);
model.physics('ht3').create('hs2', 'HeatSource', dimNb);
model.physics('ht3').feature('hs2').selection.set(fuel_domNb);
model.physics('ht3').create('hs3', 'HeatSource', dimNb);
model.physics('ht3').feature('hs3').selection.set(fuel_domNb);
